...
Create or update `stdlib/<name>/bal/README.md` using the template in `AGENTS.md`.

- **New package** → create from the template; fill in Overview, Key Functionalities, Examples, and the support table.
