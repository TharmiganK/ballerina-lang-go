...
Not covered in this subset: arbitrary user-defined message record (de)serialization via the `@protobuf:Descriptor` annotation, and the `.proto`-to-Ballerina code generator (`ballerina/grpc` and its tooling are not ported).
