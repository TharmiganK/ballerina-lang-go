...
public type Uuid record {
    langint:Unsigned32 timeLow;
    langint:Unsigned16 timeMid;
    langint:Unsigned16 timeHiAndVersion;
    langint:Unsigned8 clockSeqHiAndReserved;
    langint:Unsigned8 clockSeqLo;
    int node;
};
